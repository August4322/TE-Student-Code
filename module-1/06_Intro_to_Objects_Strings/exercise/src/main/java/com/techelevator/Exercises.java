...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		String outString = out.substring(0, 2) + word + out.substring(2); //not adding an ending takes it to the end by default
		return outString;
	}
	...
	public String extraEnd(String str) {
		String tripleString = str.substring(str.length() -2, str.length());
	...
	public String firstTwo(String str) {
		if (str.length() >= 2) {
			String firstTwoCharString = str.substring(0, 2);
	...
	public String withoutEnd(String str) {
		String withoutFirstLast = str.substring(1, str.length() - 1);
	...
	public String nonStart(String a, String b) {
		...
		String concatenationWithoutFirst = aWithoutFirst + bWithoutFirst;
		return concatenationWithoutFirst;
	}
	...
	public String left2(String str) {
		...
		String remainingLastChars = str.substring(2);
		return remainingLastChars + firstTwoChars;
	}
	...
	public String right2(String str) {
		...
		String remainingFirstChars = str.substring(0, str.length() - 2);
		return lastTwoChars + remainingFirstChars;
	}
	...
	public String nTwice(String str, int n) {
		String middleRemovedN = str.substring(0, n) + str.substring(str.length() -n);
		return middleRemovedN;
	}
	...
	public boolean hasBad(String str) {
		if (str.length() < 3) {
			return false;
		} else if (str.indexOf("bad") == 0) {
			return true;
		} else if (str.indexOf("bad") == 1) {
			return true;
		}
		return false;
	}
	...
	public String frontTimes(String str, int n) {
		...
		return firstThreeChar.repeat(n);
	}
	...
	public int countXX(String str) {
		int countAppearanceOfXX = 0;

		for (int i = 0; i < str.length(); i ++)
			if (str.startsWith("xx", i)) {
				countAppearanceOfXX ++;
			}
		return countAppearanceOfXX;
	}
	...
	public boolean doubleX(String str) {
		...
		return str.substring(isXThere, isXThere + 2).equals("xx");
	}
	...
	public String stringX(String str) {
		...
		for (int i = 0; i < str.length(); i ++) {
			String desiredChar = str.substring(i, i + 1);
			if (!(i > 0 && i < (str.length() -1) && str.charAt(i) == 'x')) { //originally had (str.substring(i, i+1).equals("x")) but the inteli-sense simplified to .charAt
				removedXS += desiredChar;
			}
		}
		return removedXS;
	}
	...
	public String altPairs(String str) {
		...
		for (int i = 0; i < str.length(); i += 4) {
			int char0N1 = i + 2;
			if (char0N1 > str.length()) {
				char0N1 = str.length();
			}
			removed2N3 += str.substring(i, char0N1);
		}
		return removed2N3;
	}
