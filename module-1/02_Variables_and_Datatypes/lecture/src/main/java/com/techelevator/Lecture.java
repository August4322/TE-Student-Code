...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int subtractionPractice = (121 - 27);
		System.out.println(subtractionPractice);

		/*
		11. Create a double that holds the addition of 12.3 and 32.1.
		*/

		double additionPractice = (12.3 + 32.1);
		System.out.println(additionPractice);

		/*
		12. Create a String that holds your full name.
		*/

		String myFullName = "August Newman";
		...
		*/
		...
		System.out.println(66.6/100); //The answer is wrong because the computer has trouble storing large information in bytes so the info is .00..01 off
		...
		*/
		...
		long billions = (long)1_000_000_000 * 3; //int will not work because the result is too large
